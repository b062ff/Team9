        ...
        if($PageNum==4){?>
            <?php if(count($home_list)!=0){?>
                ...
                <div class="messageBox">
                    ...
                    <div> 
                    <input type="button" class="btn-text-31d"  value="スタート
"  id="submitBtn" onclick="Starttest()" v-on:click="submit" :disabled="!isWork"></button></div>
                </div>
            </div>
            <?php }?>
            <form method="post" action="<?php echo($_SERVER["SCRIPT_NAME"])?>">
                <input type="hidden" name= "page" value=4>
                <button name="back" type="submit" class="btn-text-3d" >戻る</button>
            </form>
            </div>
